...
//template <typename T>
//! Function to partition the list that is to be sorted.
...
//template<typename T>
//! Function to quicksort each partitions available of the list to be sorted.
